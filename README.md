...
This is the team project for the team "Data Scientists" for the DS105L Lent Term. The goal of the project is to use county panel data to understand the relationship between indicators of years of experience and education and measures of welfares in counties in the United States using census data.
